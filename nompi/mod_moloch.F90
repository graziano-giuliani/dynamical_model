...
!$acc routine seq
  ...
  subroutine moloch(istep, lprint)
    ...
    if ( lprint ) then
      ...
      if ( is_nan(maxp) .or. is_nan(minp) .or. &
           is_inf(maxp) .or. is_inf(minp) ) then
      ...
      write(output_unit,'(a,2f8.2)') &
          ' $$$ max, min of ps (mb) = ', maxp*d_r100 , minp*d_r100
      write(output_unit,'(a,2f8.2)') &
          ' $$$ max, min of u (m/s) = ', maxu , minu
      write(output_unit,'(a,2f8.2)') &
          ' $$$ max, min of v (m/s) = ', maxv , minv
    end if
    !
    ...
    subroutine divergence_filter( )
      implicit none
      integer(ik4) :: j , i , k
      zdiv2(jce1ga,ice1:ice2,:) = zdiv2(jce2,ice1:ice2,:)
      zdiv2(jce2ga,ice1:ice2,:) = zdiv2(jce1,ice1:ice2,:)
      zdiv2(jce1:jce2,ice1ga,:) = zdiv2(jce1:jce2,ice2,:)
      zdiv2(jce1:jce2,ice2ga,:) = zdiv2(jce1:jce2,ice1,:)
      do k = 1 , kz
    ...
    subroutine filtpai
      ...
      pai(jce1ga,ice1:ice2,:) = pai(jce2,ice1:ice2,:)
      pai(jce2ga,ice1:ice2,:) = pai(jce1,ice1:ice2,:)
      pai(jce1:jce2,ice1ga,:) = pai(jce1:jce2,ice2,:)
      pai(jce1:jce2,ice2ga,:) = pai(jce1:jce2,ice1,:)
      do k = 1 , kz
        do concurrent ( j = jci1:jci2, i = ici1:ici2 )
    ...
    subroutine filttheta
      ...
      tetav(jce1ga,ice1:ice2,:) = tetav(jce2,ice1:ice2,:)
      tetav(jce2ga,ice1:ice2,:) = tetav(jce1,ice1:ice2,:)
      tetav(jce1:jce2,ice1ga,:) = tetav(jce1:jce2,ice2,:)
      tetav(jce1:jce2,ice2ga,:) = tetav(jce1:jce2,ice1,:)
    ...
    subroutine sound(dts)
      ...
      do nsound = 1 , mo_nsound
        ...
        u(jde1ga,ice1:ice2,:) = u(jde2,ice1:ice2,:)
        u(jde2ga,ice1:ice2,:) = u(jde1,ice1:ice2,:)
        u(jde1:jde2,ice1ga,:) = u(jde1:jde2,ice2,:)
        u(jde1:jde2,ice2ga,:) = u(jde1:jde2,ice1,:)
        u(jde2ga,ice2ga,:) = u(jde1,ice1,:)
        u(jde1ga,ice2ga,:) = u(jde2,ice1,:)
        u(jde1ga,ice1ga,:) = u(jde2,ice2,:)
        u(jde2ga,ice1ga,:) = u(jde1,ice2,:)
        v(jce1ga,ide1:ide2,:) = v(jce2,ide1:ide2,:)
        v(jce2ga,ide1:ide2,:) = v(jce1,ide1:ide2,:)
        v(jce1:jde2,ide1ga,:) = v(jce1:jce2,ide2,:)
        v(jce1:jde2,ide2ga,:) = v(jce1:jce2,ide1,:)
        v(jce2ga,ide2ga,:) = v(jce1,ide1,:)
        v(jce1ga,ide2ga,:) = v(jce2,ide1,:)
        v(jce1ga,ide1ga,:) = v(jce2,ide2,:)
        v(jce2ga,ide1ga,:) = v(jce1,ide2,:)
        ...
        pai(jce1:jce2,ice1ga,:) = pai(jce1:jce2,ice2,:)
        pai(jce1:jce2,ice2ga,:) = pai(jce1:jce2,ice1,:)
        deltaw(jce1ga,ice1:ice2,:) = deltaw(jce2,ice1:ice2,:)
        deltaw(jce2ga,ice1:ice2,:) = deltaw(jce1,ice1:ice2,:)
        deltaw(jce1:jce2,ice1ga,:) = deltaw(jce1:jce2,ice2,:)
        deltaw(jce1:jce2,ice2ga,:) = deltaw(jce1:jce2,ice1,:)
    ...
    subroutine wafone(pp,dta,pfac,pmin)
      ...
      wz(jce1:jce2,ice1ga,:) = wz(jce1:jce2,ice2,:)
      wz(jce1:jce2,ice2ga,:) = wz(jce1:jce2,ice1,:)
      wz(jce1:jce2,ice1gb,:) = wz(jce1:jce2,ice2-1,:)
      wz(jce1:jce2,ice2gb,:) = wz(jce1:jce2,ice1+1,:)
      ...
      if ( lrotllr ) then
        ...
        p0(jce1ga,ice1:ice2,:) = p0(jce2,ice1:ice2,:)
        p0(jce2ga,ice1:ice2,:) = p0(jce1,ice1:ice2,:)
        p0(jce1gb,ice1:ice2,:) = p0(jce2-1,ice1:ice2,:)
        p0(jce2gb,ice1:ice2,:) = p0(jce1+1,ice1:ice2,:)
  ...
  subroutine xtouvstag(ux,vx,u,v)
    ...
    ux(jce1ga,ice1:ice2,:) = ux(jce2,ice1:ice2,:)
    ux(jce2ga,ice1:ice2,:) = ux(jce1,ice1:ice2,:)
    ux(jce1gb,ice1:ice2,:) = ux(jce2-1,ice1:ice2,:)
    ux(jce2gb,ice1:ice2,:) = ux(jce1+1,ice1:ice2,:)
    vx(jce1:jce2,ice1ga,:) = vx(jce1:jce2,ice2,:)
    vx(jce1:jce2,ice2ga,:) = vx(jce1:jce2,ice1,:)
    vx(jce1:jce2,ice1gb,:) = vx(jce1:jce2,ice2-1,:)
    vx(jce1:jce2,ice2gb,:) = vx(jce1:jce2,ice1+1,:)
  ...
  subroutine uvstagtox(u,v,ux,vx)
    ...
    u(jde1ga,ice1:ice2,:) = u(jde2,ice1:ice2,:)
    u(jde2ga,ice1:ice2,:) = u(jde1,ice1:ice2,:)
    u(jde1gb,ice1:ice2,:) = u(jde2-1,ice1:ice2,:)
    u(jde2gb,ice1:ice2,:) = u(jde1+1,ice1:ice2,:)
    v(jce1:jce2,ide1ga,:) = v(jce1:jce2,ide2,:)
    v(jce1:jce2,ide2ga,:) = v(jce1:jce2,ide1,:)
    v(jce1:jce2,ide1gb,:) = v(jce1:jce2,ide2-1,:)
    v(jce1:jce2,ide2gb,:) = v(jce1:jce2,ide1+1,:)
